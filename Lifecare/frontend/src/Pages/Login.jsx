  ...
  return (
    <form className='min-h-[80vh] flex items-center'>
        <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
          ...
          <p className='text-2-xl font-semibold'>{state === 'Sign Up' ? "Create Account" : "Login"}</p>
          ...
          <div  className='w-full'>
            <p>Email</p>
            <input className='border border-zinc-300 rounded w-full p-2 mt-1 ' type="mail" onChange={(e)=>setEmail(e.target.mail)} value={email} />
          </div>
          <div  className='w-full'>
            <p>Password</p>
